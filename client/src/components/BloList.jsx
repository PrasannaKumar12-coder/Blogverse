...
// import BlogsInfo from './BlogsCard'
...
const BloList = () => {
  ...
  const TruncateTextHeading = ({ text }) => {
    ...
    const truncated =
      words.length > 11 ? words.slice(0, 11).join(" ") + "..." : text;
  ...
  return (
    <>
      {/* categories */}
      <div
        className='d-flex justify-content-center gap-2 gap-sm-4 gap-md-4 gap-lg-4  py-3'
        style={{ cursor: "pointer" }} >
        {BlogItems.map(item => (
          <motion.button
            whileTap={{ scale: 0.95 }}
            key={item} onClick={() => setMenu(item)}
            initial={{ x: -50, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            className={` fs-6 fs-sm-5 fs-md-4 fs-lg-3 rounded-5  border-0 fs-0 py-0 py-sm-1 px-3 ${menu === item && 'text-white bg-primary'}`}
          >{item}
            <motion.div
              layoutId='underline'
        ...
        <div className="row justify-content-center text-center">
          <div className="col-12 col-md-8 col-lg-6">
            ...
            <p className="text-muted mb-4" style={{ fontSize: "0.95rem" }}>
              Subscribe to get the latest updates and articles directly in your inbox.
            </p>
      ...
      {/* footer */}
      <footer style={{ backgroundColor: "#dcdde0" }} className="text-center text-md-start py-5">
        <div className="container">

          {/* Brand */}
          <div className="mb-4">
            <h2 className="fw-bold  mb-2"><span style={{ color: "#28a745" }}>Blog</span>Verse<span style={{ color: "#28a745" }}>.</span></h2>
          ...
          <div className="row align-items-center justify-content-center justify-content-md-between mb-4">
            ...
            <div className="col-12 col-md-4 mb-3 mb-md-0">
              <ul className="list-unstyled d-flex justify-content-center justify-content-md-start gap-3 mb-0">
                ...
                <li><a href="#!" className="text-primary text-decoration-none">Blog</a></li>
                <li><a href="#!" className="text-primary text-decoration-none">About</a></li>
                <li><a href="#!" className="text-primary text-decoration-none">Contact</a></li>
              </ul>
            </div>
